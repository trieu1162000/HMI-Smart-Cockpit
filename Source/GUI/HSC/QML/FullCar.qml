        ...
        Node {
            ...
            Node {
                ...
                Node {
                    ...
                    // Target end position of the line
                    Node {
                        id: lineEnd
                        property vector3d worldPosition: position
                        position: Qt.vector3d(lineOpenFrunk.position.x, lineOpenFrunk.position.y, lineOpenFrunk.position.z + lineGeometry.length)  // End of the line
                    }
                    // 3D Button
                    // Model {
                    //     id: my3DButton
